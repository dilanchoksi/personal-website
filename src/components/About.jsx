      ...
      <div className="flex flex-wrap xl:items-center">
        ...
        >
          <div className="flex items-center justify-center xl:w-96 2xl:w-auto">
            <img
              src={aboutImg}
              alt=""
              className="rounded-full border-8 w-72 mb-10 md:mb-0 md:w-96 lg:w-96 hover:scale-105 duration-300"
            />
          </div>
        </motion.div>
        <motion.div
        ...
        >
          <div className="flex justify-center lg:justify-start">
            <p className="max-w-xl sm:text-lg leading-[19px] md:text-xl text-center md:text-start 2xl:py-8 hover:scale-105 duration-300">
              {ABOUT_TEXT}
            </p>
          </div>
        </motion.div>
